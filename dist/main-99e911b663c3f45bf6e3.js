...
;// CONCATENATED MODULE: ./src/config/route.ts
var routeConfig = [{
  name: 'service worker',
  path: '/',
  exact: true,
  component: function component() {
    return __webpack_require__.e(/* import() */ 26).then(__webpack_require__.bind(__webpack_require__, 26));
  }
}, {
  name: 'mobx demo',
  path: '/mobx',
  component: function component() {
    return __webpack_require__.e(/* import() */ 85).then(__webpack_require__.bind(__webpack_require__, 85));
  }
}, {
  name: '小游戏',
  path: '/games',
...
;// CONCATENATED MODULE: ./src/components/LoadingPage/index.tsx

/* harmony default export */ const LoadingPage = (function () {
  return /*#__PURE__*/react.createElement("div", null, "jia zai zhong !");
});
;// CONCATENATED MODULE: ./src/uitls/getRoutes.tsx





var getLoadableComponent = function getLoadableComponent(route) {
  return lib_default()({
...
function getRoutes(routes, parentPath) {
  return /*#__PURE__*/react.createElement(Switch, null, routes.map(function (i) {
    var path = "".concat(parentPath + i.path).replace(/\/+/g, '/');
    ...
    if (i.children) {
      ...
      if (i.redirect) {
        ...
        return /*#__PURE__*/react.createElement(Route, {
          ...
          exact: i.exact,
          strict: i.strict,
          component: getLoadableComponent(i)
        });
      }
    }
  }));
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./src/style/index.less
...
var src_elements = getRoutes(routeConfig, '/');
react_dom.render( /*#__PURE__*/react.createElement(HashRouter, null, src_elements), document.getElementById('root'));
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "zetianul.github.io:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkzetianul_github_io"] = self["webpackChunkzetianul_github_io"] || [];
